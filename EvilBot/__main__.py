...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [�😁](https://telegra.ph/file/db4a0538f0f88635ef968.png) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *�Creeper*
...
buttons = [
    [
     ...
     [
        ...
        InlineKeyboardButton(
            text="𝐌𝐲 𝐖𝐞𝐛🌐", url=f"https://telegra.ph/Creeper-11-21"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/catuserbot17"),
    ], 
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` �😁 *�Creeper* [�😁](https://telegra.ph/Creeper-11-21)
`𝙲𝚕𝚒𝚌𝚔 𝚘𝚗 𝚝𝚑𝚎 𝚋𝚞𝚝𝚝𝚘𝚗𝚜 𝚋𝚎𝚕𝚘𝚠 𝚝𝚘 𝚐𝚎𝚝 𝚍𝚘𝚌𝚞𝚖𝚎𝚗𝚝𝚊𝚝𝚒𝚘𝚗 𝚊𝚋𝚘𝚞𝚝 𝚜𝚙𝚎𝚌𝚒𝚏𝚒𝚌 𝚖𝚘𝚍𝚞𝚕𝚎𝚜..`"""
evil_IMG = "https://telegra.ph/Creeper-11-21"
